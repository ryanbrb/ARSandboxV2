...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        // sandbox controller
        public GameObject sandBoxControllerV2;
        //private ARSandboxControllerV2 generateEnvironment;
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_NewPlanes.Count; i++)
            {
                ...
                // Generate path prefab
                sandBoxControllerV2.GetComponent<ARSandboxControllerV2>().GenerateAnchorAndObject(m_NewPlanes[i], m_NewPlanes[i].CenterPose.position);
            }
        }
    }
}
