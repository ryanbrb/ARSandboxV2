    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5861 = frac(node_5251.r);
                float node_8879 = lerp(-1,4,node_5861);
                v.vertex.xyz += (v.normal*saturate(((((1.0 - distance((-1*(mul(unity_ObjectToWorld, v.vertex).g-node_8879)),(mul(unity_ObjectToWorld, v.vertex).g-(node_8879+(-1.0)))))-0.96)*10.0)-0.3)));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_5314 = distance(i.posWorld.rgb,float3(0,0,0));
