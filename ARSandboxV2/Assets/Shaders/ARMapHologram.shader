    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(lerp(0.0,saturate((fmod(((sceneUVs.g*0.5+0.5)*_ScreenParams.g),4.0)-2.0)),saturate((-1*(distance(i.posWorld.rgb,float3(0,0,0))-lerp(10.0,30.0,_circle_size))))) - 0.5);
////// Lighting:
////// Emissive:
