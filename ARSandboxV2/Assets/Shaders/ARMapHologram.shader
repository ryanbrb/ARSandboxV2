    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_3268 = saturate((-1*(node_5314-(node_6458-0.1))));
                clip(saturate((saturate((node_2536*node_7401))+node_3268)) - 0.5);
////// Lighting:
////// Emissive:
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 emissive = ((node_2536*0.2)+((_MainTex_var.rgb*_Color.rgb)-(distance(0.0,i.posWorld.g)*0.25)));
